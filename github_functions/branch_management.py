...
def merge_branch_and_pr(github: Github, repo_full_name: str, from_branch: str, to_branch: str, reviewers: list[str], labels: list[str]) -> None:
    ...
    create_branch_from_repo(repo, from_branch, new_from_branch)
    ...
    pull_request = create_pull_request_by_repo(repo, pr_name, pr_description, to_branch, new_from_branch, is_draft=False)
